...
public struct BatchTransferResult_V1: Codable {
    /// Transaction ID
    ...
    public static func fromJSONString(_ jsonString: String) -> BatchTransferResult_V1? {
        ...
        do {
            return try decoder.decode(BatchTransferResult_V1.self, from: data)
        } catch {
            return nil
        }
    }
