//
//  MultisigTransferResult_V1.swift
//  Bitcoin
//
...
public struct MultisigTransferResult_V1: Codable {
    /// Transaction ID
    ...
    public static func fromJSONString(_ jsonString: String) -> MultisigTransferResult_V1? {
        ...
        do {
            return try decoder.decode(MultisigTransferResult_V1.self, from: data)
        } catch {
            return nil
        }
    }
